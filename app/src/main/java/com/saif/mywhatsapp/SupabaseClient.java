...
public class SupabaseClient {
    ...
    private static final String API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imlzc25waWl6b3dwa3l6a3VzZWxtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzgxMDQ1MzMsImV4cCI6MjA1MzY4MDUzM30.pFEpj0E_NIqcmd0UIQXuOUVLAQoW8j_c-Gd56XPYoZo"; // Replace with your actual API key
                    ...
                    .client(new OkHttpClient.Builder().addInterceptor(new Interceptor() {
                        ...
                        public Response intercept(Chain chain) throws IOException {
                            Request newRequest = chain.request().newBuilder()
                                    .addHeader("apikey", API_KEY) // Add the API key in the header
